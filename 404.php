...
<div class="err">
	...
	<?php var_dump(MuPlayer_Plugin::out()); ?>
<div id="img">
<h5>以下是一些随机文章</h5><a href="<?php $this->options->feedUrl(); ?>" title="立即订阅<?php $this->options->title() ?>"><div class="rss_single">订阅<?php $this->options->title() ?></div></a>
      <ul class="shit">
